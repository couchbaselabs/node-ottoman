...
// TODO: Maybe pick a better name than FieldGroup?
function FieldGroup() {
  this.fields = [];
}

FieldGroup.prototype.field = function(name) {
...
// TODO: Maybe pick a better name than ListDesc?
...
Schema.prototype.fieldVal = function (mdl, name) {
  // TODO: Improve this to not use eval!
