...
var debug = require('debug')('ottoman:ModelInstance');
_.mixin(lodashDeep);
...
ModelInstance.prototype._toCoo = function (refType, forceTyping) {
  debug('_toCoo()');
  debug('  refType: %s', refType);
  debug('  forceTyping: %s', forceTyping);
  var $ = this.$;
  var objOut = {};
