...
ModelInstance.prototype.id = function() {
  var $ = this.$;
  if (!$.loaded) {
    var keyPrefix = $.schema.namePath() + $.schema.separator;
  ...
  var newKey = $.schema.namePath() + $.schema.separator + myId;
  if ($.key !== null) {
    if ($.key !== newKey) {
...
ModelInstance.ref = function(id) {
  return this.refByKey(this.schema.namePath() + $.schema.separator + id);
};
