...
Ottoman.prototype.parseFieldType = function(options) {
  if (!options) {
  ...
  if (this.isTypeDef(options.type)) {
    ...
    return this.parseFieldType(options);
  }
...
Ottoman.prototype._makeField = function(name, fieldDef) {
  ...
  field.type = this.parseFieldType(fieldDef);
