...
/**
 * @typedef {TypeName|Model|Schema|SchemaDesc|FullTypeDesc} TypeDesc
 */
 ...
 */
Ottoman.prototype.model = function(name, schemaDesc, options) {
  ...
  var schemaName = '__S_' + name;

  var schema = this._parseSchemaDesc(schemaName, schemaDesc);
 ...
 * @param {Object} [options]
 */
Ottoman.prototype.schema = function(name, schemaDesc, options) {
  if (options === undefined) {
    options = {};
  }
  ...
  var schema = this._parseSchemaDesc(name, schemaDesc);
...
/**
 * @callback EnsureIndexesCallback
 * @param {Error} err
 */

/**
 *
 * @param {EnsureIndexesCallback} callback
 */
Ottoman.prototype.ensureIndexes = function(callback) {
  // TODO: Implement me!
};
 ...
 *
 * @param {EnsureIndexesCallback} callback
 * @deprecated Renamed to {@link Ottoman#ensureIndexes} instead.
 */
Ottoman.prototype.ensureIndices = function(callback) {
  return this.ensureIndexes(callback);
};
