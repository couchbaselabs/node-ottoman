...
Schema.prototype._tryAddViewQueryFn = function(name, queryDef) {
  var remoteTypeName = queryDef.of;
  var remoteField = queryDef.by;

  var remoteType = this.context._typeByName(remoteTypeName);
  if (!remoteType) {
    this.context._delayBind(remoteTypeName, this._tryAddViewQueryFn.bind(this, name, queryDef));
    return;
  }
...
Schema.prototype.addViewQueryFn = function(name, queryDef) {
  this._tryAddViewQueryFn(name, queryDef);
