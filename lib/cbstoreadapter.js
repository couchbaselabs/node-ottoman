...
CbStoreAdapter.prototype.kvGet = function (key, callback) {
  if (this.debug) {
    console.log('CbStoreAdapter::kvGet', key);
  }
...
CbStoreAdapter.prototype.kvStore = function (key, data, cas, callback) {
  if (this.debug) {
    console.log('CbStoreAdapter::kvStore', key, cas, data);
  }
...
CbStoreAdapter.prototype.kvRemove = function (key, cas, callback) {
  if (this.debug) {
    console.log('CbStoreAdapter::kvRemove', key, cas);
  }
