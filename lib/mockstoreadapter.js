...
MockStoreAdapter.prototype.dbGet = function (key, callback) {
  if (this.debug) {
    console.log('MockStoreAdapter::dbGet', key);
  }
...
MockStoreAdapter.prototype.dbStore = function (key, data, cas, callback) {
  if (this.debug) {
    console.log('MockStoreAdapter::dbStore', key, cas, data);
  }
...
MockStoreAdapter.prototype.dbRemove = function (key, cas, callback) {
  if (this.debug) {
    console.log('MockStoreAdapter::dbRemove', key, cas);
  }
